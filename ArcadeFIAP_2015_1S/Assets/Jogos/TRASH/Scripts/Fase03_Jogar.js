...
function Update () {
	...
	tVertical =  ArcadeFIAP.Eixo (1, EEixo.VERTICAL);
	tAtirar1 = (ArcadeFIAP.BotaoApertado(1, EBotao.A))? 1: 0; // Input.GetAxis ("TRASH_Atirar1");
	tAtirar2 = (ArcadeFIAP.BotaoApertado(1, EBotao.B))? 1: 0; // Input.GetAxis ("TRASH_Atirar2");
